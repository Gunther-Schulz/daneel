...
blocked-by: decision whether skill-craft Durability-classes takes the run-count discriminator, which skill-craft own Reflexivity rule reserves to the operator
